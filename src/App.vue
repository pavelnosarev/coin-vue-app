  ...
  <div id="app">
    <header class="header-area header-padding-2 sticky-bar header-res-padding clearfix">
      <div class="container-fluid">
        <div class="row">
          <!-- <div class="col-xl-9 col-lg-2 col-md-6 col-4"> -->
          <div class="logo">
            <a href="/">
              <img alt="" src="assets/img/logo/logo.png" class="logo" />
            </a>
          </div>
          <!-- </div> -->
                      ...
                      <li>
                        <ul>
                          <li class="mega-menu-img">
                            <a href="shop.html"><img src="assets/img/banner/banner-12.png" alt="" /></a>
                          </li>
                        </ul>
                      </li>
                    </ul>
            ...
            <nav id="mobile-menu-active">
              <ul class="menu-overflow">
                ...
                <li>
                  <a href="/coins/new">Add New Coin</a>
                  <!-- <ul>
                    <li><a href="/coins/new">coin standard</a></li>
                    <li><a href="/coins/new">coin no sidebar</a></li>
                    <li><a href="/coins/new">coin right sidebar</a></li>
                    <li><a href="/coins/new">coin details 1</a></li>
                    <li><a href="/coins/new">coin details 2</a></li>
                    <li><a href="/coins/new">coin details 3</a></li>
                  </ul> -->
                </li>
                <li><a href="/about">About us</a></li>
              </ul>
